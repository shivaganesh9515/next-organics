...
import { LayoutDashboard, Image as ImageIcon, Store, Settings, LogOut, Users } from 'lucide-react'
    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-64 bg-black/40 backdrop-blur-xl border-r border-white/10 hidden md:flex flex-col p-6 shadow-2xl z-20">
        ...
        <div className="flex items-center gap-3 mb-10">
          <div className="w-10 h-10 rounded-xl bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold border border-purple-500/20 shadow-lg shadow-purple-900/20">
             SA
          </div>
          <div>
        ...
        <nav className="space-y-1.5 flex-1">
          ...
          <NavItem href="/manufacturers" icon={Store} label="Manufacturers" />
        ...
        <div className="pt-4 border-t border-white/5">
            <button className="flex items-center gap-3 text-sm text-red-400 hover:text-red-300 transition-colors p-3 rounded-lg hover:bg-red-500/10 w-full">
