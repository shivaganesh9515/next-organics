...
/// Grid product card for "Best Selling" section
/// Optimized for 2-column grid layout with 0.7 aspect ratio
class GridProductCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GridProductCard> createState() => _GridProductCardState();
}

class _GridProductCardState extends ConsumerState<GridProductCard> {
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              // Product Image (55-60% of card)
              Expanded(
                flex: 58,
                child: Hero(
                  tag: 'grid-${widget.product.id}',
                  child: ClipRRect(
...
/// Quantity selector for grid card
